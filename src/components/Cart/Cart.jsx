                                            ...
                                            <div key={product._id}>
                                                <div className={`d-flex justify-content-between ${cart.length > 1 ? 'border-bottom border-tertiary mb-3 pb-3' : ''}`}>
                                                    ...
                                                    <div className='text-end'>
                                                        <button className='border-0 mb-5 bg-transparent' onClick={() => { removeFromCart(product._id); showEmptyCart() }}>
                                                        ...
                                                        <button className={cartStyles.qtybtn} >
                                                            <svg onClick={() => updateQuantity(product._id, product.quantity > 1 ? product.quantity - 1 : product.quantity)} width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            ...
                                                            {product.quantity}
                                                            <svg onClick={() => updateQuantity(product._id, product.quantity + 1)} width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
